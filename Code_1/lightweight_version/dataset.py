...
def load_and_preprocess_data(config, data_path=None):
    ...
    # 创建数据集
    train_dataset = TimeSeriesDataset(train_data, config.INPUT_LENGTH, config.OUTPUT_LENGTH)
    val_dataset = TimeSeriesDataset(val_data, config.INPUT_LENGTH, config.OUTPUT_LENGTH)
    test_dataset = TimeSeriesDataset(test_data, config.INPUT_LENGTH, config.OUTPUT_LENGTH)
